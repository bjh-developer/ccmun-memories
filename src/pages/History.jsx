...
const MILESTONES = [
  ...
  },
  {
    ...
    goh: { name: 'Ms Olivia Tan Jia Yi', sub: 'Senior Geopolitical Risk Consultant, Expeditors International · Alumnus' }, slotId: 'hist-2023', placeholder: 'CCMUN I, 2023', final: false,
  },
  {
    ...
    goh: { name: 'Ms Ann Neo Zixin', sub: 'Journalist, The Straits Times' }, slotId: 'hist-2024', placeholder: 'CCMUN II, 2024', final: false,
  },
  {
    ...
    goh: { name: 'Prof Kishore Mahbubani', sub: 'Distinguished Fellow, Asia Research Institute, NUS' }, slotId: 'hist-2025', placeholder: 'CCMUN III, 2025', final: false,
  },
  {
    ...
    goh: { name: 'Ms Liew Wei Lin', sub: 'Assistant Director, Ministry of Foreign Affairs, Singapore' }, slotId: 'hist-2026', placeholder: 'CCMUN IV, 2026', final: true,
  },
]
