      ...
      <section className="letter-sec">
        <div className="wrap">
          <div className="letter reveal">
            ...
            <p>Let me be upfront: this was an ambitious idea. A group of Secondary 4 students, with no dedicated MUN CCA and no guarantee anyone would continue after we left, all while preparing for our O Levels. If you had asked any reasonable person whether this would work, they would have politely, and very reasonably, said no.</p>
            <p>And here is the thing that still strikes me, even now. Unlike schools with established MUN CCAs built to outlast any single cohort, CCMUN has never had that luxury. Every year it existed was because a fresh group of students looked at the uncertainty, the workload, the complete absence of any guarantee, and said yes anyway. That is the whole story.</p>
            <p>To our teachers and the school, thank you. Thank you to our teacher-in-charge, Ms Chan Ann Chin Valerie, to the Humanities Department, and to our Principal, Mr Terence Yao, for trusting a student's idea with classrooms, time, and patience. You did not have to say yes. You did. That matters more than I can put into words.</p>
            ...
            <p>To the juniors reading this: though CCMUN has come to an end, the spirit behind it need not. The audacity to be the first, to try the thing that has no roadmap, to bet on passion when there are no guarantees — that does not need CCMUN to survive. Your school needs people who are willing to start something, not just join something. Be that person. Your wild, reckless, crazily ambitious idea might just become someone else's four-year legacy.</p>
